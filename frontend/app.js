      ...
      ${job.status === 'done' ? `
        <div class="job-actions">
          ${job.video_url ? `
            ...
            <a class="btn-download-video" href="${job.video_url}" download="${job.concept.replace(/\s+/g,'_')}_${job.job_id.split('_').slice(-2).join('_')}.mp4" onclick="event.stopPropagation()">⬇ Download</a>
